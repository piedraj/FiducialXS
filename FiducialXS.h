...
// Wed May 20 16:44:07 2015 by ROOT version 5.34/23
// from TChain demo/Tree/
//////////////////////////////////////////////////////////
...
//   TBranch        *b_T_METgen_Phi;   //!
   ...
   FiducialXS(Int_t index = -1, TTree *tree = 0);
   virtual ~FiducialXS();
...
#ifdef FiducialXS_cxx
FiducialXS::FiducialXS(Int_t index, TTree *tree) : fChain(0)
{
...
FiducialXS::~FiducialXS()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t FiducialXS::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t FiducialXS::LoadTree(Long64_t entry)
{
...
void FiducialXS::Init(TTree *tree)
{
...
void FiducialXS::Show(Long64_t entry)
{
...
Int_t FiducialXS::Cut(Long64_t entry)
{
